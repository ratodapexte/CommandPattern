...
public abstract class Employee
{
    ...
    public static void addEmployee(ArrayList<Employee> listOfEmployee)
    {
        ...
        switch(choice) {
            case 1:
                President newPresident = President.newEmployee();
                listOfEmployee.add(newPresident);
                break;
            case 2:
                Medic newMedic = Medic.newEmployee();
            ...
            case 3:
                ...
                break;
            case 4:
                PersonalTrainer newTrainer = PersonalTrainer.newEmployee();
                listOfEmployee.add(newTrainer);
                break;
            case 5:
                Driver newDriver  = Driver.newEmployee();
                listOfEmployee.add(newDriver);
                break;
            case 6:
                Cooker newCooker = Cooker.newEmployee();
                listOfEmployee.add(newCooker);
                break;
            case 7:
                Lawyer newLawyer = Lawyer.newEmployee();
                listOfEmployee.add(newLawyer);
                break;
            case 8:
                Player newPlayer = Player.newEmployee();
